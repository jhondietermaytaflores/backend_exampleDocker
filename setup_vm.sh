...
# Asume que el sistema operativo es Ubuntu/Debian.
...
echo "--- 3. Configurando Firewall Interno (UFW en Puerto 80 y 3000) ---"
# Instala e inicializa UFW si no está activo
sudo apt install -y ufw
# Abre el puerto 80 (Frontend) y 3000 (Backend)
...
echo "--- 5. Instalación de Docker y Docker Compose completada ---"
